...
public class WydarzeniaMedyczne implements Table {
	...
	public boolean deleteItem (String name) throws SQLException {
		return Database.executeUpdate("DELETE FROM wydarzenia_medyczne WHERE nazwa = " + Tables.nullCheck(name) + ";") != 0;
	}
	
	public boolean updateItem (String oldName, String newName) throws SQLException {
		return Database.executeUpdate("UPDATE wydarzenia_medyczne SET nazwa = " + Tables.nullCheck(newName) 
